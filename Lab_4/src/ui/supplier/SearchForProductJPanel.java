...
//        String idString = idField.getText(); // 获取输入的 ID 字符串
//        int id = Integer.parseInt(idString); // 将字符串转换为整数
//        Product result = ProductCatalog.SearchProduct(id); // 使用整数作为参数
        
        String idString = idField.getText(); // 获取输入的 ID 字符串
        int id = Integer.parseInt(idString); // 将字符串转换为整数
       // 实例化 ProductCatalog 类
       ProductCatalog catalog = supplier.getProductCatalog();
       // 使用实例调用非静态方法 searchProduct
         Product result = catalog.searchProduct(id); // 使用整数作为参数

        
        
//        Product result = ProductCatalog.searchProduct(idField.getText());
...
//        int id = Integer.parseInt(idField.getText());
        if(result == null){
            ...
            ViewProductDetailJPanel panel = new ViewProductDetailJPanel(workArea,result );
